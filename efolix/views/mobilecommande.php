...
<div class="top_pic" style="<?php echo base_url();?>efolix/assets/image/mc/c_bg.jpg">
	<div class="pic_div">
		<div class="left">
    		<img id="focus1" src="<?php echo base_url();?>efolix/assets/image/mc/focus_3.png" />
            <img id="focus2" src="<?php echo base_url();?>efolix/assets/image/mc/focus_4.png" style="display:none;" />
   		</div>
   		<div class="right">
            <input id="email" type="text" class="email" placeholder="留下邮箱免费试用">
...
<div class="cont" style="padding-top:646px;">
    ...
    <div class="ipad">
        ...
        <div class="m1">
    		<img src="<?php echo base_url();?>efolix/assets/image/mc/mc_01.png" width="958" height="340" />
    	</div>
        
        <div class="m1">
    		<img src="<?php echo base_url();?>efolix/assets/image/mc/mc_02.jpg" width="958" height="418" />
    	</div>

        <div class="m1">
            <img src="<?php echo base_url();?>efolix/assets/image/mc/mc_03.jpg" width="958" height="397" />
        </div>

        <div class="m1">
            <img src="<?php echo base_url();?>efolix/assets/image/mc/mc_04.jpg" width="958" height="349" />
        </div>
